...
.text-input,.title-input,.dropdown,.submit-button {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   closeInbox: () => (/* binding */ closeInbox),
...
const printTodos = (todos) => {
    todos.forEach(todoObj => {
        ;(0,_todosDOM__WEBPACK_IMPORTED_MODULE_2__.addToTray)(todoObj);
    });
}
...
const handleInputs = () => {
    ...
    (0,_todos__WEBPACK_IMPORTED_MODULE_1__.addTodo)(inputTitle.value,inputDesc.value,"20",inputProject.value,false,false)
}
